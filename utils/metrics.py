...
def show_metrics():
    ...
    suggested_radius_slider = (
        st.session_state.suggested_radius_slider
    ...
    if (
        ...
        and suggested_radius_slider is not None
        ...
        previous_date_from = date_from - (date_to - date_from) + timedelta(days=1)
        ...
        with col1:
            st.metric(
                ...
                value=f"{suggested_radius_slider}{location['radius_unit']}",
